...
{
    public class ConfigurationBuilder : Builder<IConfiguration>
    {
        ...
        public ConfigurationBuilder AllowedConnections(int count)
        {
            _allowedConnections = count;
            return this;
        }

        public ConfigurationBuilder ReadTimeout(int timeout)
        {
            _readTimeout = timeout;
            return this;
        }

        public ConfigurationBuilder WriteTimeout(int timeout)
        {
            _writeTimeout = timeout;
            return this;
        }

        public ConfigurationBuilder MaximumMessageSize(int size)
        {
            if(size <= 0)
        ...
        public ConfigurationBuilder ReceiveTimeout(int timeout)
        {
            _receiveTimeout = timeout;
            return this;
        }

        public ConfigurationBuilder SendTimeout(int timeout)
        {
            _sendTimeout = timeout;
            return this;
        }

        public ConfigurationBuilder ReceiveBufferSize(int timeout)
        {
            _receiveBufferSize = timeout;
            return this;
        }

        public ConfigurationBuilder SendBufferSize(int timeout)
        {
            _sendBufferSize = timeout;
            return this;
        }

        internal override IConfiguration Build()
        {
            SetDefaults();
